export const usersData: Record<string, any> = {
  ...
  3: {
    ...
    prompt: `
      ...
      Embrace unpredictability: Incorporate elements of surprise, humor, or empathy to simulate human-like responses.
    `,
  },
  4: {
    name: 'Rosalee Melvin',
    username: '@rosalee',
    image: 'rosalee-melvin.jpg',
    prompt: `
